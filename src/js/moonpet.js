...
function getStatusMessage() {
	...
	// Very positive
	if (petState.happiness > 90) {
		return 'unreasonably happy.';
	}
...
initialize();
petElements.feedButton.addEventListener('click', () => {
	performAction('feed');
});
petElements.playButton.addEventListener('click', () => {
	performAction('play');
});
petElements.speakButton.addEventListener('click', () => {
	performAction('speak');
});
